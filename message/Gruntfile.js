        ...
        watch: {
            ...
            livereload: {
                files: [
                    ...
                    '<%= yeoman.appWsite %>/images/{,*//*}*.{png,jpg,jpeg,gif,webp,svg}'
                ],
            ...
            dist: {
                files: {
                    src: [
                        ...
                        '<%= yeoman.distWsite %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}',
        ...
        imagemin: {
            dist: {
                files: [{
                    ...
                    expand: true,
                    cwd: '<%= yeoman.appWsite %>/images',
                    src: '{,*/}*.{png,jpg,jpeg,gif}',
                    dest: '<%= yeoman.distWsite %>/images'
                }]
            }
        },
